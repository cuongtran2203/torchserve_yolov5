...
class MyHandler(BaseHandler):
    ...
    def initialize(self, context):
        ...
        # model_file_path="model_ver2.onnx"
        # self.providers = ['CPUExecutionProvider']
        # self.session = onnxruntime.InferenceSession(model_file_path, providers=self.providers)
    ...
    def postprocess(self,preds):
        ...
        for pred in y :
            ...
            res.append({"label":str(pred[5]),"bbox":box,"score": str(pred[4])})
        return [res]
